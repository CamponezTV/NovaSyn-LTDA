...
const translations = {
  pt: {
    ...
    "portfolio.item1.title": "Vende.AI",
    "portfolio.item1.description": "Plataforma de automação de vendas no WhatsApp com IA",
    "portfolio.item1.tag1": "IA",
    "portfolio.item1.tag2": "Automação",
    "portfolio.item1.tag3": "WhatsApp",
    "portfolio.inDevelopment": "Em Desenvolvimento",
    "portfolio.item2.title": "Sistema de Gestão E-commerce",
    "portfolio.item2.description": "Sistema completo de gestão para lojas online",
    "portfolio.item2.tag1": "E-commerce",
    "portfolio.item2.tag2": "Dashboard",
    "portfolio.item2.tag3": "Analytics",
    "portfolio.item3.title": "Website Corporativo",
    "portfolio.item3.description": "Site institucional moderno e responsivo",
    "portfolio.item3.tag1": "Website",
    "portfolio.item3.tag2": "Design",
    "portfolio.item3.tag3": "Responsivo",
    ...
    "faq.q6.question": "O que diferencia a Nova Syn de outras empresas de tecnologia?",
    ...
    "privacy.section1.content": "A Nova Syn LTDA está comprometida em proteger sua privacidade. Esta Política de Privacidade explica como coletamos, usamos, divulgamos e protegemos suas informações pessoais quando você utiliza nosso site e serviços.",
    ...
    "terms.section1.content": "Ao acessar e usar os serviços da Nova Syn LTDA, você concorda em cumprir estes Termos de Serviço. Se você não concordar com algum destes termos, não utilize nossos serviços.",
    "terms.section2.title": "2. Descrição dos Serviços",
    "terms.section2.intro": "A Nova Syn oferece serviços de desenvolvimento e consultoria em tecnologia, incluindo:",
    ...
    "terms.section4.content": "Todo o conteúdo, design, código e materiais fornecidos pela Nova Syn são protegidos por direitos autorais e outras leis de propriedade intelectual. Os direitos sobre trabalhos customizados serão definidos em contrato específico para cada projeto.",
    "terms.section5.title": "5. Limitação de Responsabilidade",
    "terms.section5.content": "A Nova Syn não se responsabiliza por danos indiretos, incidentais ou consequentes resultantes do uso ou incapacidade de usar nossos serviços. Nossa responsabilidade total não excederá o valor pago pelos serviços.",
  ...
  en: {
    ...
    "portfolio.item1.title": "Vende.AI",
    "portfolio.item1.description": "WhatsApp sales automation platform with AI",
    "portfolio.item1.tag1": "AI",
    "portfolio.item1.tag2": "Automation",
    "portfolio.item1.tag3": "WhatsApp",
    "portfolio.inDevelopment": "In Development",
    "portfolio.item2.title": "E-commerce Management System",
    "portfolio.item2.description": "Complete management system for online stores",
    "portfolio.item2.tag1": "E-commerce",
    "portfolio.item2.tag2": "Dashboard",
    "portfolio.item2.tag3": "Analytics",
    "portfolio.item3.title": "Corporate Website",
    "portfolio.item3.description": "Modern and responsive corporate website",
    "portfolio.item3.tag1": "Website",
    "portfolio.item3.tag2": "Design",
    "portfolio.item3.tag3": "Responsive",
    ...
    "faq.q6.question": "What sets Nova Syn apart from other technology companies?",
    ...
    "privacy.section1.content": "Nova Syn LTDA is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you use our website and services.",
    ...
    "terms.section1.content": "By accessing and using Nova Syn LTDA's services, you agree to comply with these Terms of Service. If you do not agree with any of these terms, do not use our services.",
    "terms.section2.title": "2. Description of Services",
    "terms.section2.intro": "Nova Syn offers technology development and consulting services, including:",
    ...
    "terms.section4.content": "All content, design, code, and materials provided by Nova Syn are protected by copyright and other intellectual property laws. Rights to custom work will be defined in specific contracts for each project.",
    "terms.section5.title": "5. Limitation of Liability",
    "terms.section5.content": "Nova Syn is not responsible for indirect, incidental, or consequential damages resulting from the use or inability to use our services. Our total liability will not exceed the amount paid for the services.",
