...
const translations = {
  pt: {
    ...
    "portfolio.item2.title": "Novabuild",
    "portfolio.item2.description": "Plataforma por assinatura para auxiliar engenheiros com suas obras",
    "portfolio.item2.tag1": "Dashboard",
  ...
  en: {
    ...
    "portfolio.item1.tag3": "WhatsApp",
    "portfolio.item2.title": "Novabuild",
    "portfolio.item2.description": "Subscription platform to assist engineers with their projects",
    "portfolio.item2.tag1": "Dashboard",
