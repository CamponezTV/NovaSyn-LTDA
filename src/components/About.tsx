...
const About = () => {
  ...
  return (
    <section id="sobre" className="py-24 bg-gradient-hero relative overflow-hidden">
      {/* Decorative elements */}
            ...
            <div className="aspect-square rounded-3xl bg-gradient-primary/10 border-2 border-primary/20 p-8 flex items-center justify-center backdrop-blur-sm shadow-glow hover-lift">
              <div className="text-center space-y-8">
                ...
                <div className="space-y-2 animate-scale-in animation-delay-200">
                  ...
                  <p className="text-xl text-foreground/70">{t("about.stat2")}</p>
                </div>
                <div className="space-y-2 animate-scale-in animation-delay-400">
                  <p className="text-6xl font-bold text-secondary">24/7</p>
                  <p className="text-xl text-foreground/70">{t("about.stat3")}</p>
                </div>
              </div>
            </div>
            {/* Floating decoration */}
