  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 relative z-10 w-full flex items-center justify-center min-h-screen lg:h-full">
        <div className="max-w-6xl w-full pt-48 pb-12 lg:py-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            {/* Right side - 3D Logo */}
            <div className="hidden lg:flex justify-center items-center opacity-0 animate-fade-up animation-delay-500">
